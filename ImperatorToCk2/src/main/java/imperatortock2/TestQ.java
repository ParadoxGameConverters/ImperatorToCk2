...
public class TestQ {
    ...
    public static int combineTest() throws IOException {
    ...
    public static String[] Test(int y) throws IOException {
        ...
        String Dir2 = "C:" + VM + "Users" + VM + "User" + VM + "Documents" + VM + "Paradox Interactive" + VM + "Crusader Kings II" + VM + "mod";
        test = Processing.importBaronyNameList(Dir2, y, Dir1);
        int aqq = 0;
        FileOutputStream fileOut = new FileOutputStream("C:" + VM + "Users" + VM + "User" + VM + "Documents" + VM + "Paradox Interactive" + VM + "Test.txt");
